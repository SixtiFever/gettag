...
export default function DataHandlingPage() {
  return (
    <LegalPageLayout currentPage="your-data">
      <PageMeta
        title="Your Data — Tag"
        description="How Tag handles your data, including account deletion and what is removed or kept."
      />
      ...
      <section className="legal-page__section" aria-labelledby="data-delete-steps">
        ...
        <ol className="legal-page__list legal-page__list--ordered">
